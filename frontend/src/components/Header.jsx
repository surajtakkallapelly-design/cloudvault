...
export default function Header({ searchVal, setSearchVal, filesCount, totalSize }) {
  ...
  return (
    <header className="sticky top-0 z-10 flex h-16 w-full items-center justify-between border-b border-zinc-200 dark:border-zinc-900/60 bg-white/70 dark:bg-zinc-950/80 px-6 backdrop-blur-md transition-colors duration-300">
      {/* Search Input */}
      <div className="relative w-96">
        ...
        <input
          ...
          className="block w-full rounded-xl border-0 bg-zinc-100 dark:bg-zinc-900/50 pl-10 pr-3 py-2 text-sm text-zinc-800 dark:text-white placeholder-zinc-500 ring-1 ring-inset ring-zinc-200 dark:ring-zinc-800 focus:ring-2 focus:ring-indigo-500 focus:outline-none transition-all"
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-4 bg-zinc-100/50 dark:bg-zinc-900/40 border border-zinc-200 dark:border-zinc-900/50 rounded-xl px-4 py-2">
